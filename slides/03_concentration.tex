...
\begin{axis}[
    ...
    \addplot[domain=-5:5, samples=100, color=blue, thick] {ln(exp(x)/2 + 1/2)};
    %\addplot[black, mark=*, only marks] coordinates {(0, 0)};
    %\addplot[domain=-5:5, samples=100, color=red, thick] {-2*x};
...
\begin{axis}[
    ...
    \addplot[domain=0:1, samples=100, color=blue, thick] {x*ln(2*x) + (1-x)*ln(2*(1-x))};
...
\begin{axis}[
    ...
    \addplot[domain=-5:5, samples=100, color=blue, thick] {x^2/2};
    %\addplot[black, mark=*, only marks] coordinates {(0, 0)};
    %\addplot[domain=-5:5, samples=100, color=red, thick] {-2*x};
...
\begin{axis}[
    ...
    \addplot[domain=-5:5, samples=100, color=blue, thick] {exp(x) - 1};
    %\addplot[black, mark=*, only marks] coordinates {(0, 0)};
    %\addplot[domain=-5:5, samples=100, color=red, thick] {-2*x};
    \draw[dashed, black] (axis cs:0, -1) -- (axis cs:0, 5);
    \draw[dashed, black] (axis cs:-5, 0) -- (axis cs:5, 0);
...
\begin{axis}[
    ...
    \addplot[domain=0:5, samples=100, color=blue, thick] {x*ln(x)-x+1};
    %\addplot[black, mark=*, only marks] coordinates {(0, 0)};
    %\addplot[domain=-5:5, samples=100, color=red, thick] {-2*x};
    \draw[dashed, black] (axis cs:0, 0) -- (axis cs:0, 5);
...
I_X(a) &= a\log\frac{a}{\lambda} - a + \lambda\qquad\text{for } a > 0.
\end{align*}
\end{frame}
...
\begin{axis}[
    ...
    \addplot[domain=-5:5, samples=100, color=blue, thick] {ln(1/(1-x))};
    %\addplot[black, mark=*, only marks] coordinates {(0, 0)};
    %\addplot[domain=-5:5, samples=100, color=red, thick] {-2*x};
...
\begin{axis}[
    ...
    \addplot[domain=0:5, samples=100, color=blue, thick] {x-1-ln(x)};
    %\addplot[domain=-5:5, samples=100, color=red, thick] {-2*x};
    \draw[dashed, black] (axis cs:0, 0) -- (axis cs:0, 5);
    \draw[dashed, black] (axis cs:0, 0) -- (axis cs:5, 0);
    \addplot[black, mark=*, only marks] coordinates {(1, 0)};
