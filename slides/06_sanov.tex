...
$m=2$のとき、
\begin{align*}
\mathcal{P}_3&\coloneq\left\{\left(\frac{0}{3},\,\frac{3}{3}\right),\,\left(\frac{1}{3},\,\frac{2}{3}\right),\,\left(\frac{2}{3},\,\frac{1}{3}\right),\,\left(\frac{3}{3},\,\frac{0}{3}\right)\right\}\\
P_{12211}&\coloneq \left(\frac{3}{5},\,\frac{2}{5}\right)
\end{align*}
\end{example}
\end{frame}
...
\begin{align*}
\KL{q}{p} &\coloneq \sum_kq_k\log \frac{q_k}{p_k}.
\end{align*}
\end{definition}
...
\Pr(P_{\symbf{X}}= q) &= \binom{N}{Nq_1\,Nq_2\,\dotsm Nq_m} \prod_{k=1}^m p_k^{Nq_k}\\
 ...
 &= \emm{\Pr(\symbf{Y}\in T_q)}\prod_{k=1}^m\left(\frac{p_k}{q_k}\right)^{Nq_k}\\
 &=\emm{\Pr(\symbf{Y}\in T_q)}\mathrm{e}^{-N \KL{q}{p}}.
%=\mathrm{e}^{-N \KL{q}{p}}.
\end{align*}
